...
public class named_entity {
	public static void main(String[] args)
	{
		try {
			File inputFile = new File("/Sem-2/Social computing/Final project/good files/10.xml");
