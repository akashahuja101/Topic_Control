		...
		try {
			...
			for (int temp = 0; temp < nList.getLength(); temp++) {
				...
				if (nNode.getNodeType() == Node.ELEMENT_NODE) {
					...
					if(eElement.getAttribute("link_to").contains("lynn"))
					{
					count ++;
							
					}
					else if(eElement.getAttribute("link_to").contains("jake"))
					{
					count1 ++;
					}
					else if(eElement.getAttribute("link_to").contains("macy"))
					{
					count2 ++;
					}
					else if(eElement.getAttribute("link_to").contains("melany"))
					{
					count3 ++;
					}
					else if(eElement.getAttribute("link_to").contains("ariel"))
					{
					count4 ++;
					}
					else if(eElement.getAttribute("link_to").contains("irene"))
					{
					count5 ++;
					}
					else if(eElement.getAttribute("link_to").contains("luke"))
					{
					count6 ++;
					}
					else if(eElement.getAttribute("link_to").contains("ariel"))
					...
					else if(eElement.getAttribute("link_to").contains("tia"))
					{
					count8 ++;
					}
					else if(eElement.getAttribute("link_to").contains("moderator"))
					{
					count9 ++;
					}
